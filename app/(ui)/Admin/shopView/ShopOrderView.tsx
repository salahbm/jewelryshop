            ...
            <form>
              <CardContent>
                <Grid container spacing={5}>
                  ...
                  <GridItem
                    label="배송 주소 1:"
                    value={data?.od_delivery_address1}
                  />
                  <GridItem
                    label="배송 주소 2:"
                    value={data?.od_delivery_address2}
                  />
                  <GridItem
                    label="배송 이메일:"
                    value={data?.od_delivery_email}
                  />
                  <GridItem label="배송 이름:" value={data?.od_delivery_name} />
                  <GridItem
                    label="배송 휴대폰:"
                    value={data?.od_delivery_phone}
                  />
                  <GridItem
                    label="배송 우편번호 1:"
                    value={data?.od_delivery_zip1}
                  />
              ...
              <form>
                <CardContent>
                  <Grid container spacing={5}>
                    ...
                    <GridItem
                      label="배송비 유형:"
                      value={cartItem?.it_sc_type}
                    />
                    <GridItem
                      label="직접 주문 여부:"
                      value={cartItem?.ct_direct}
                    />
                    ...
                    <GridItem
                      label="배송비 계산 방법:"
                      value={cartItem?.it_sc_method}
                    />
                    <GridItem
                      label="최소 배송비:"
                      value={cartItem?.it_sc_minimum}
                    />
                    <GridItem
                      label="배송비 가격:"
                      value={cartItem?.it_sc_price}
                    />
                    <GridItem
                      label="배송비 수량:"
                      value={cartItem?.it_sc_qty}
                    />
